<footer class="footer-wrapper" id="FooterElement">
   ...
   <button class="ComponentButton ScrollToTopButton Button" type="button">
      <span class="ComponentIcon ButtonIconStart Icon">
         <span class="SvgIcon MainIcon">
            <svg width="24" height="24" viewBox="0 0 24 24">
               <path fill-rule="evenodd" d="M1 16.23l11-11 11 11-2.538 2.54L12 10.307l-8.462 8.46"></path>
            </svg>
         </span>
      </span>
   </button>
      ...
      <div class="LoginFormWrapper">
         ...
         <form class="Form" novalidate="" id="login_form" onsubmit="logIn()">
            ...
            <div class="CustomLoginContent">
               <p>Güncel adresimiz <strong>www.<?=$guncel?></strong><strong>.com</strong>’dur. Bir sonraki güncellemede adresimiz <strong>www.<?=$guncel2?></strong><strong>.com</strong> olacaktır. Her zaman güncel adres için: <a href="/">https://dub.pro/mavigit</a>&nbsp;yazıp giriş yapabilirsiniz!<br>
