<section class="SectionContent">
                     ...
                     <nav class="OperatorCasinoCategories ComponentGameCategories InstanceCasino GameNavContainer OperatorCasino">
                        <div class="GameCategoriesSwipe">
                           <ul class="GameCategories Loaded CategoriesList HorizontalScrollBar List ListUnordered">
                              ...
                              <li class="CategoriesItem ListItem">
                                 <a class="ComponentAnchor GameCategory Anchor IsActive Anchor" title="Poker" id="CategoryList-Poker" href="javascript:;" onclick="loginorpay()">
   ...
   <div class="GameCategoriesWrapper">
      <h1 class="ComponentTitle InstanceCasinoCategoryTitle Title">9 Poker</h1>
      <section class="ComponentGameListGrid InstanceGeneralGameListGrid GamesList GamesListGrid CasinoGames MsnRow MsnRow">
         <div class="GamesWrapper VerticalMobileLayout">
            ...
            <ul class="GamesListContainer HorizontalScrollBar HasLoadMoreButton List ListUnordered ">
               ...
               <li class="ListGame ListItem GameTileContainer MasonryTile-1x1" data-game-id="8340053516">
                  <div class="ListGameLink Anchor">
                     <div class="ComponentGameThumbnail GameThumbContainer FrameGameThumbnail">
                        <div class="GameThumbailWrapper"><img loading="lazy" alt="Caribbean Stud Poker" class="GameThumb ListGameImage LazyImage" src="/static.ceecdncf.com/cms2/unique/_casino/5/51D0BCBF9D45CD0DABFECAD0C1461D87.optimized.png"></div>
                        <div class="GameProp GameVendorLogo" itemprop="author"><img class="GameVendorLogoImage" src="/static.ceecdncf.com/cms2/base/_casino/A/AE36B95E46312E03F7E85317EEB0F61D.png" alt="Evolution"></div>
                        <a class="ComponentAnchor GamePlayNowButton Anchor" title="Oyna Caribbean Stud Poker !" href="javascript:;" onclick="loginorpay()">
                           <div class="GamePlayNowText">Hemen Oyna!</div>
                        </a>
                        <div class="GameDetails">
                           <h3 class="GameTitle" itemprop="name">Caribbean Stud Poker</h3>
                           <div class="GameTags"></div>
                        </div>
                        <button class="FavoriteGameToggleButton Button" type="button" title="Favoriler">
                           <span class="ComponentIcon Icon">
               ...
               <li class="ListGame ListItem GameTileContainer MasonryTile-1x1" data-game-id="34814073303">
                  <div class="ListGameLink Anchor">
                     <div class="ComponentGameThumbnail GameThumbContainer FrameGameThumbnail">
                        <div class="GameThumbailWrapper"><img loading="lazy" alt="Infinite Casino Holdem" class="GameThumb ListGameImage LazyImage" src="/static.ceecdncf.com/cms2/unique/_casino/2/2698821338C112172E6319751A0DE433.optimized.png"></div>
                        ...
                        <a class="ComponentAnchor GamePlayNowButton Anchor" title="Oyna Infinite Casino Holdem !" href="javascript:;" onclick="loginorpay()">
                           <div class="GamePlayNowText">Hemen Oyna!</div>
                        </a>
                        <div class="GameDetails">
                           <h3 class="GameTitle" itemprop="name">Infinite Casino Holdem</h3>
                           <div class="GameTags"></div>
                        </div>
                        <button class="FavoriteGameToggleButton Button" type="button" title="Favoriler">
                           <span class="ComponentIcon Icon">
