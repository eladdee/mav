<section class="SectionContent ">
   <div class="ContentWrapper TextPageWrapper ComponentLayout Layout CmsStaticPage">
      <span id="ch_2402785025" class="">
         <p>GENEL KURAL VE ŞARTLAR</p>
         <p>Giriş</p>
         <p>1.1. Web sitemiz Mavibet.com (“Website”) ‘u kullanarak, ziyaret ederek veya üye olarak aşağıdaki maddeleri kabul etmiş sayılırsınız:</p>
         ...
         <p>Taraflar</p>
         <p>2.1. Mavibet.com, Curacao devleti tarafından regüle edilmektedir. This Service operates under the License No. 8048/JAZ issued to Antillephone, Authorized and Regulated by the Government of Curacao.</p>
         ...
         <p>4.7. Başka bir hesap açmak istiyorsanız geçerli sebeplerinizi yazılı olarak info@mavibet.com mail adresimize göndermeniz gerekmektedir. Yeni hesap açmak istemenizin sebebinin geçerli olduğu sonucuna varılırsa eski hesap kapatıldıktan sonra yeni hesap açmanıza izin verilir.</p>
         ...
         <p>8.3. Tek kupondan maksimum kazanç 50.000.000₺’dir. (Spor bahisi, casino, canlı casino oyunları, sanal bahisler ve tv oyunları bu kurala dahildir.)</p>
         ...
         <p>11.2. Hesap kapatma taleplerinizi ; hesap kapatma nedeniniz ile beraber ”info@mavibet.com” mail adresimize gönderim sağlayarak gerçekleştirebilirsiniz. Talebiniz işleme alındıktan sonra 60 iş günü içerisinde aktif olmamanız halinde hesabınız askıya alınacaktır.</p>
         ...
         <p>14.2. Mavibet.com yanlış bahis oranları, değişmiş oranlar(oranların yanlış takımların karşısında listelendiği) veya canlı bahis oynanabilir olmadığı zamanda yapılmış bahisleri iptal etme hakkını saklı tutar. Mavibet.com herhangi bir bahisi iptal etme, kısıtlama, reddetme ve sınırlama hakkını saklı tutar.</p>
         ...
         <p>Günlük olarak kazanılabilecek en yüksek miktar; 50.000.000₺’dir. Belirlenen miktarın üzerindeki kazançlar iptal edilebilir.</p>
         ...
         <p>Oyuncu ve site arasında daha farklı bir anlaşma olmadığı sürece 24 saatlik zaman dilimi içerisinde çekilebilecek en yüksek miktar 50.000.000₺’dir.</p>
